...
struct faucet_testnet_plugin_impl {
   ...
   results_pair create_account(const std::string& new_account_name, const fc::crypto::public_key& owner_pub_key, const fc::crypto::public_key& active_pub_key) {
      ...
      QQBC_ASSERT(creating_account != nullptr, transaction_exception,
...
const key_pair faucet_testnet_plugin_impl::_default_key_pair = {"QQBC6MRyAjQq8ud7hVNYcfnVPJqcVpscN5So8BhtHuGYqET5GDW5CV", "5KQwrPbwdL6PhXujxW37FSSQZ1JiwsST4cqQzDeyXtP79zkvFD3"};
